    ...
    if(isset($_POST['username']) && isset($_POST['password'])) 
        {
            ...
            if(!empty($_POST['username']) && !empty($_POST['password']))

                {
                    ...
                    $query="SELECT Id from users_1 where Usename='$username'  AND Passwod='$password' limit 0,1";
...
<!-- Sidebar/menu -->
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-medium w3-padding" style="z-index:3;width:460px;font-weight:bold;" id=""><br>
...
<div class="w3-main" style="margin-left:470px;margin-right:40px">
 ...
 <br><br><br>
  ...
  Username : <input type="text" name="username"  id="id1" required><br><br>
  Password : <Input type="password" name="password"  id="id2" required><br><br>
    <input type="submit" value="Login"><br><br>
   </form>
</div>
<h3>You have to put some kind of combination of SQL Syntax Parameters here of " ' " to bypass the Authentication.</h3>
</center>
</div>
