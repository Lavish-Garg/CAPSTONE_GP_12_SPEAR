...
if($query_run=mysqli_query($link, $query))
{
    ...
    {  
        ...
        $user=mysqli_fetch_array($query_run,0,Username);
        $name=mysqli_fetch_array($query_run, 0 ,Name);
        $account=mysqli_fetch_array($query_run, 0 ,Account_id);
        $amount=mysqli_fetch_array($query_run, 0 ,Amount);
...
?>
<html>
<title>CSRF in Comment Box</title>
<meta charset="UTF-8">
