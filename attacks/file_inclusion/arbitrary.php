...
<div class="w3-main" style="margin-left:470px;margin-right:40px">
  <center><h1>Arbitrary File Upload</h1></center>
  <br><br>
...
//move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)
 ...
 {
    echo "The file has been uploaded in as ". $target_dir .basename($_FILES['fileToUpload']['name']). ".";
    } 
else {
...
?>
<br><h4><p>You can Upload any Arbitrary File here such as "b374k" to access the Command Prompt of the Server in which you can execute any query you want.<p></h4>
 <!-- page end -->
</div>
<script>
