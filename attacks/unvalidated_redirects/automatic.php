...
<html>
<title>Automatic Redirects</title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:470px;margin-right:40px">
  <center><h1>Automatic Redirects</h1></center>
  <br><br>
<section class="content">
<span id="c">
<h4><p>In Automatic Redirects, You are going through a Untrusted Website in which if you click on an image or just visit a page, you automaically redirected to a Bad Malicious Website or Website having Bad Content in just a blink of your eye.<p></h4>
</span><br>
...
{//document.write("You will be redirected to main page in 5 sec.");
   ...
   setTimeout('window.location="welcome.html";', 2000); 
