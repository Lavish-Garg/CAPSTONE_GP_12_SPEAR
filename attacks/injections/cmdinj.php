...
<center><h1>Command Injection</h1>
<body topmargin="30" leftmargin="30" rightmargin="30"><br><br>
<form action="" mehtod="POST">
<input type="text" name="ip" placeholder="Enter IP here to Ping."><br><br>
<input type="submit" value="SUbmit">
</form><br><br><br>
<h3>The goal is execution of arbitrary commands on the host operating system via a vulnerable application. Enter the IP of your network, if the IP is active, it'll show the "Ping Results" else it'll show "Ping Unsuccessfull".</h3>
</center><br>
<?php
if(isset($_GET['ip']))
{  $host=$_GET['ip'];
