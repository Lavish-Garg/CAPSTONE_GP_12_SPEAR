...
<div class="w3-main" style="margin-left:470px;margin-right:40px">
 <center><h1>Manual Redirects</h1></center>
<center><br>
<form action="virus.php" method="GET">
<centre><h2> Enter To Your Facebook Account </centre></h2><br>
Username : <input type="text" name="user" placeholder="" required><br><br>
Password : <input type="password" name="pass" placeholder="" required><br><br>
<a href="virus.php">
    <input type="submit" value="Login">
</a>

</form>
<h4><p>In Manual Redirects, You Login to a Untrusted Website with your any Social Media Credentials and you redirected to a bad malicious site or the site having bad content. There can be a change in redirectTo value in url OR in a Button, you should examine it and then login into a particular website.<p></h4>
</center>
 <!-- page end -->
