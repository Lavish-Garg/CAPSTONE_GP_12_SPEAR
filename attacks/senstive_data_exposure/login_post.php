<html>
<title>User Credentials Sent in Plaintext</title>
<meta charset="UTF-8">
...
<center><h1><?php echo $title;?></h1></center>
 <br><br>
  ...
  Password : <Input type="password" name="password"  id="id2" required><br><br>
   ...
   <br><br>
   <h3>The Credentials are sent in Plaintext to the Database without using any Encryption Format. Check the URL after Login.</h3>
</div>
</center>
</div>
