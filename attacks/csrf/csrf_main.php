...
<div class="w3-main" style="margin-left:470px;margin-right:40px">
  ...
  <center><h1>Cross-Site Request Forgery (CSRF)</h1></center>
 
<section class="content">
<br><br>
<span id="c"><b>What is Cross-Site Request Forgery (CSRF)?</b></span><br>
...
CSRF .. target functionality that causes a state change on the server, such as changing the victim's email address or password, or purchasing something. Forcing the victim to retrieve data doesn't benefit an attacker because the attacker doesn't receive the response, the victim does. As such, CSRF .. target state-changing requests.</p><br>
...
<span id="c"><b>Are You Vulnerable To 'Cross-Site Request Forgery (CSRF)'?</b></span><br>
...
<span id="c"><b>Example Attack Scenarios</b></span><br>
