...
{
{
 echo "<center><h1>WELCOME TO THE SPEAR VAPT SIMULATION TOOL</h1><br>";  
...
<div class="w3-sidebar w3-red w3-collapse w3-top w3-medium w3-padding" style="z-index:3;width:460px;font-weight:bold;" id=""><br>
  ...
  <div class="w3-container" align="center">
    <h3 class="w3-padding-50"> <a href="index.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white"><b>SPEAR VAPT<br>SIMULATION<br>TOOL</b></a></h3>
  </div>
...
<header class="w3-container w3-top w3-hide-large w3-red w3-xlarge w3-padding">
  ...
  <span><b>SPEAR VAPT SIMULATION TOOL</b></span>
</header>
...
<center><h1>Welcome to the SPEAR VAPT Simulation Tool.</h1></center>
<section class="content">
<br>

<p>SPEAR VAPT Simulation Tool is a PHP/MySQL based Web Simulator that Covers the Top Ten Attacks of OWASP-2021. The motive of creating the VAPT Simulator is to practice and perform the practicals of OWASP Top 10 - 2021,
...
<ul>
<li>SPEAR VAPT Simulation Tool contains all the vulnerabilities from OWASP Top 10. Go to through the "About" page of every vulnerability before starting the practical.</li>
<li>To start the LVS, you need a localhost Web Platform Server. We recommend you to use XAMPP. XAMPP is a free and open source cross-platform web server solution stack package developed by Apache Friends, consisting mainly of the Apache HTTP Server, MariaDB database, and interpreters for scripts written in the PHP and SQL programming languages.</li>
<li>You have to install the latest version of XAMPP first in your Operating System. When completed, open the installed folder of "XAMPP", go to "htdocs" and paste the folder "LVS" inside it.</li>
<li>Once copied, Open your Browser and write "localhost/lvs" OR "127.0.0.1/lvs" in the URL and hit Enter.</li>
<li>You'll find the "Create Database" option. Click on that for creating the database for LVS and again go to "localhost/lvs" OR "127.0.0.1/lvs".</li>
<li>You'll get the FrontEnd of the VAPT Simulator. Enjoy learning how the attacks works.</li>
</ul>  
...
<ul>
<li>Lavish Garg</li>
<li>Siddharth Verma</li> 
<li>Aayushi Tripathi</li>  
<li>Abhishek Motlani</li>     
</ul>
