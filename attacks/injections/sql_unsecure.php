...
<body>
  <center><h1>Union Based Sql Injection</h1>
  <style>
form {
...
<table>
  <table height="80">
  <tr>
    <th><p align="center"><font size="20"></p></th></font>
  <tr>
  </tr>
</table>
  ...
  <h2>Enter Your ID</h2>
<center>
  <form action="sql_unsecure.php" method="GET">
<input type="text" name="id" placeholder="Enter value here" required>
...
$query_run=mysqli_query($link, $query1) or die(mysqli_error($link));

    while($row=mysqli_fetch_array($query_run))
    {  
        echo "<center>CardNo : ". $row['CardNo'] ."</center><br>";
        echo "<center>CVV : ".$row['CVV'] ."</center><br>";
        echo "<center>Gender : ". $row['Gender'] ."</center><br>";
        echo "<center>Username : ".$row['Username'] ."</center><br>";
        echo "<center>Pin : ".$row['Pin'] ."</center><br>";
    }
}
else
{
...
?>
 ...
 <h4>In Union-Based Sql Injection you'll get GET parameters such as "php?id=". To check that if a Website is Vulnerable to Union-based SQL Injection you have to put " ' " in the login form and it'll provide you a SQL Syntax Error.</h4>
 <!-- page end -->
</div>
