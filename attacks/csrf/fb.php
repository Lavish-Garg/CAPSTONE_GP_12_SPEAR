...
<div style ="margin-left:5%">
 <h3 align="center">Enter your comment</h3> 
<form action=fb.php method="GET" align="center">
  <textarea rows="4" cols="30" name="comment">
    </textarea><br>
  <input type="submit" value="Post">
</form>
<a href="logout1.php"><h3>Logout</h3><br></a>
</div>
<style>
#ad
{
...
<br><img src="ad.jpg" height="230" width="350" id="ad"></img><br>
</a>
...
#$name=$_SESSION['name'];
$query1="INSERT INTO `project`.`csrf3`(`Message`) VALUES ('$comment');";
if($queryrun=mysqli_query($link, $query1))
{
  echo "<div style ='margin-left:45%'>Comment posted</div>";
}
}

echo "<html><body><div style ='margin-left:25%'><center><u><b><br>All Comments from Admin</b></u><br></center></div></body></html>";
$query="Select * from csrf3";
echo "<br>";
#echo "<html><body><div style ='margin-left:25%'><center><h4>&nbsp;Comment<br></h4></center></div></body></html>";
if($query_run=mysqli_query($link, $query))
{ 
  while($row=mysqli_fetch_array($query_run))
{
$msg=$row['Message'];
echo "<html><body><div style ='margin-left:25%'><center>&nbsp;$msg<br><br></center></div></body></html>";
}
}
?>
...
<div class="w3-sidebar w3-red w3-collapse w3-top w3-medium w3-padding" style="z-index:3;width:460px;font-weight:bold;" id=""><br>
  ...
  <div class="w3-container" align="center">
    <h3 class="w3-padding-50"> <a href="../../index.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white"><b>LUCIDEUS<br>VAPT<br>SIMULATOR</b></a> </h3>
  </div>
...
<header class="w3-container w3-top w3-hide-large w3-red w3-xlarge w3-padding">
  ...
  <span><b>LUCIDEUS VAPT SIMULATOR</b></span>
</header>
