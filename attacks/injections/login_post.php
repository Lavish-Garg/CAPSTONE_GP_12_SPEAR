...
<!-- Sidebar/menu -->
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-medium w3-padding" style="z-index:3;width:460px;font-weight:bold;" id="mySidebar"><br>
...
<div class="w3-main" style="margin-left:470px;margin-right:40px">
 ...
 <br><br><center><h1><?php echo $title;?></h1></center>
 <br><br><br>
   <center>
