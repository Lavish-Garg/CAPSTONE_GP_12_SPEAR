...
if($query_run=mysqli_query($link, $query1))
{
  while($row=mysqli_fetch_array($query_run))
    {   
        echo "<center>Username : ". $row['Usename'] ."</center><br>";
        echo "<center>Password : ".$row['Passwod'] ."</center><br>";
          #echo'<center><a href="sde.php"><h2>Back</h2></a>
  #<a href="../../index.php"><h2>VAPT Simulator</h2></a></center>';
    }
}
}
else
{
    echo "<center><div style ='margin-left:26%'><h1>Plaintext Passwords from Database</h1></center></div><br><br><br>";
    echo "<center><div style ='margin-left:26%'><h2>Enter ?Id=1 / ?Id=2 etc. in URL</center></h2><br></div>";
    echo "<center><div style ='margin-left:26%'><p>By entering ?Id=1 / ?Id=2 you will get Credentials from <br>the Database with the help of Union Based Sql <br>Injection in which you'll get 'GET' parameters.</p></center></div>";
}
?>

<html>
<title>Credentials in Plaintext</title>
<meta charset="UTF-8">
